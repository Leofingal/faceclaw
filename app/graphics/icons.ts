...
export const ICON_SVGS = {
  ...
  // Not a Lucide icon: the TLC bilateral mark (four curves approaching a
  // limit line, which is broken at the limit point), for Ghost. Drawn for
  // the single global stroke width.
  tlc:
    '<svg viewBox="0 0 24 24" fill="none"><path d="M 1.2,19.2 C 3.75,18.9 6.3,18 8.25,16.2 C 9.02,15.43 9.67,14.43 10.2,13.19"/><path d="M 1.2,4.8 C 3.75,5.1 6.3,6 8.25,7.8 C 9.02,8.57 9.67,9.57 10.2,10.81"/><path d="M 22.8,19.2 C 20.25,18.9 17.7,18 15.75,16.2 C 14.98,15.43 14.33,14.43 13.8,13.19"/><path d="M 22.8,4.8 C 20.25,5.1 17.7,6 15.75,7.8 C 14.98,8.57 14.33,9.57 13.8,10.81"/><line x1="12" y1="1" x2="12" y2="9.6"/><line x1="12" y1="14.4" x2="12" y2="23"/></svg>',
} as const;
